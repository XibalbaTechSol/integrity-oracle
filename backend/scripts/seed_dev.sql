...
INSERT INTO agents (
    ...
    450,
    0.1500,
    '{"alias": "Sovereign_Slacker", "verification_tier": 1, "grounding_score": 400, "staked_amount_itk": 50.0, "owner_uid": "mock_dev_uid"}'::jsonb
);
...
INSERT INTO agents (
    ...
    820,
    0.0300,
    '{"alias": "Verified_Voyager", "verification_tier": 2, "grounding_score": 850, "staked_amount_itk": 500.0, "owner_uid": "mock_dev_uid"}'::jsonb
);
...
INSERT INTO agents (
    ...
    1000,
    0.0050,
    '{"alias": "Institutional_Ironclad", "verification_tier": 3, "grounding_score": 980, "staked_amount_itk": 5000.0, "owner_uid": "mock_dev_uid"}'::jsonb
);
